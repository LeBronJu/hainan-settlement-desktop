...
| `docs/dev-notes/stage2-template-candidate-browser-2026-07-23.md` | 当前架构 note | 大量分表模板候选的 5 个随机分批、Excel 式关键词搜索、安全签名边界和跨省复用方案。 |
...
| `docs/dev-notes/settlement-year-2027-readiness-2026-07-23.md` | 当前架构 note | 2027 年年份参数化、各模块就绪度、1 月跨年风险和新台账适配待确认事项。 |
