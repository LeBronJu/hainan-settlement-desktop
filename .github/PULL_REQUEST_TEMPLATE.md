...
- [ ] Ran the relevant tests or explained why tests are not needed.
- [ ] Confirmed no real ledgers, customer data, settlement outputs, screenshots, or sensitive finance data are included.
